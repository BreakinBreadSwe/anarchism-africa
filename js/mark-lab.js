...
(function () {
  const STYLES = [
    ...
    ['riso',             'Riso overprint (fluoro)'],
    ['goldleaf',         'Gold leaf'],
    ['screenprint',      'Screenprint poster'],
    ['graffiti',         'Spraypaint stencil'],
    ['woodcut',          'Woodcut / linocut'],
    ['cuttest',          'Punk zine cut-and-paste'],
    ['pattern',          'Repeating pattern (tile)'],
    // ── Typography eras + movements ──────────────────────────────────────
    ['artdeco',          '1920s Art Deco'],
    ['bauhaus',          '1920s Bauhaus'],
    ['constructivist',   '1920s Soviet Constructivist'],
    ['swissintl',        '1950s Swiss International'],
    ['cubanrev',         '1960s Cuban revolutionary (OSPAAAL)'],
    ['blackpanthers',    '1970s Emory Douglas / Black Panthers'],
    ['memphis',          '1980s Memphis Group'],
    ['vaporwave',        '1990s Vaporwave'],
    ['brutalconcrete',   '70s Brutalist on concrete'],
    // ── Cultural traditions (countries / lineages) ───────────────────────
    ['afrofuturist',     'Afrofuturist cosmic'],
    ['cyberafro',        'Cyber Afro-future'],
    ['adinkra',          'Ghanaian Adinkra stamps'],
    ['ndebele',          'Ndebele wall painting (SA)'],
    ['ankara',           'West African Ankara wax-print'],
    ['ethiopiancross',   'Ethiopian manuscript'],
    ['islamicgeo',       'Islamic geometric (N.Africa)'],
    ['zellige',          'Moroccan zellige tile'],
    ['haitianvev',       'Haitian Vèvè ritual'],
    ['taino',            'Taíno petroglyph'],
