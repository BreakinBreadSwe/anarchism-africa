      ...
      page.innerHTML = `
        ...
        <div class="aa-auth-grid">
          ...
          <div class="aa-auth-form" id="aa-auth-form" data-mode="signin">
            ...
            <!-- Staff/partner passcode login removed 2026-06 — feels insecure
                 (shared role passcodes) and is redundant now that the magic
                 link covers everyone. Staff/partners use the same email magic
                 link; role is assigned server-side from the email allowlist. -->
